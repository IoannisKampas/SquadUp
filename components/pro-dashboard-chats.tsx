...
export default function ProDashboardChats() {
  ...
  if (chatRooms.length === 0) {
    return (
      <div className="mt-4 rounded-lg border border-gray-800 bg-gray-900/50 p-8 text-center">
        ...
        <p className="text-gray-500 text-sm mt-2">Chat rooms will appear here when you accept orders from customers</p>
      </div>
    )
  }
          ...
          <div className="grid md:grid-cols-3 h-[600px]">
            ...
            <div className="border-r border-gray-800 overflow-y-auto">
              <div className="p-4 border-b border-gray-800">
                <h3 className="font-medium">Chat Rooms</h3>
              </div>
            ...
            <div className="col-span-2 flex flex-col">
              {selectedChatId ? (
                user?.id ? (
                  <OrderChat chatRoomId={selectedChatId} currentUserId={user.id} userType="pro" />
                ) : (
